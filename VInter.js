...
//try
  ...
  //
    ...
    //这一部分是correlation算式。
    cal(){
      var s =this.calculator.calNumerator(this.array1,this.array2)/this.calculator.calDenominator(this.array1,this.array2);
      this.result1 = s;
    ...
    reg(){
      var h = this.calculator.regNumerator(this.array1,this.array2)/this.calculator.regDenominator(this.array1);
      this.result3 = h;
      this.result4 = this.calculator.avgOfArray(this.array2) - h* this.calculator.avgOfArray(this.array1);
